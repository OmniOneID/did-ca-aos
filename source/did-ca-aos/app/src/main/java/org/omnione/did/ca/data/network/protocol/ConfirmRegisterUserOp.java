...
public final class ConfirmRegisterUserOp {

    private ConfirmRegisterUserOp() {}

    public static String call(NetworkManager net, Context ctx, String tasBaseUrl,
                              String registerResultTxId, String serverToken)
            throws CommunicationException {
        P132RequestVo req = new P132RequestVo(CaUtil.createMessageId(ctx), registerResultTxId);
        req.setServerToken(serverToken);
        return net.send(tasBaseUrl + "/tas/api/v1/confirm-register-user",
                "POST", req.toJson());
    }
}
