...
public final class RetrieveKycOp {

    private RetrieveKycOp() {}

    public static String call(NetworkManager net, Context ctx, String tasBaseUrl,
                              String txId, String serverToken, String kycTxId)
            throws CommunicationException {
        P132RequestVo req = new P132RequestVo(CaUtil.createMessageId(ctx), txId);
        req.setServerToken(serverToken);
        req.setKycTxId(kycTxId);
        req.setKycToken(null);
        return net.send(tasBaseUrl + "/tas/api/v1/retrieve-kyc", "POST", req.toJson());
    }
}
