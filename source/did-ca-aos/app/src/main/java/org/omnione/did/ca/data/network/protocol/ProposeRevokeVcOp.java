...
public final class ProposeRevokeVcOp {
    ...
    private ProposeRevokeVcOp() {}

    public static Result call(NetworkManager net, Context ctx, String tasBaseUrl, String vcId)
            throws Exception {
        P220RequestVo req = new P220RequestVo(CaUtil.createMessageId(ctx));
        req.setVcId(vcId);
        String resp = net.send(tasBaseUrl + "/tas/api/v1/propose-revoke-vc", "POST", req.toJson());
