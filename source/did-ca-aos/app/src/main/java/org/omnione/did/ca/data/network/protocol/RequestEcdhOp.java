...
public final class RequestEcdhOp {
    ...
    public static final class Result {
        ...
        Result(String rawResponseJson, byte[] clientNonce, EcKeyPair dhKeyPair) {
    ...
    public static Result call(NetworkManager net, Context ctx, String tasBaseUrl,
        ...
        EcdhRequestBuilder.Built built =
                EcdhRequestBuilder.build(walletApi, Constants.DID_DOC_TYPE_DEVICE);
