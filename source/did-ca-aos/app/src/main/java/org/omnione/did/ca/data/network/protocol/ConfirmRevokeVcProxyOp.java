...
public final class ConfirmRevokeVcProxyOp {
    private ConfirmRevokeVcProxyOp() {}

    public static String call(NetworkManager net, Context ctx, String proxyBaseUrl, String txId)
            throws Exception {
        P220RequestVo req = new P220RequestVo(CaUtil.createMessageId(ctx), txId);
        return net.send(proxyBaseUrl + "/proxy/api/v1/confirm-revoke-vc",
                "POST", req.toJson());
    }
}
