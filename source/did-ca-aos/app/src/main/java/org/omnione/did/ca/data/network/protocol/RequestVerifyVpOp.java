...
public final class RequestVerifyVpOp {

    private RequestVerifyVpOp() {}

    public static String call(NetworkManager net, Context ctx, String verifierBaseUrl,
                              String txId, String encVp, AccE2e accE2e) throws Exception {
        P310RequestVo req = new P310RequestVo(CaUtil.createMessageId(ctx), txId);
        req.setEncVp(encVp);
        req.setAccE2e(accE2e);
        return net.send(verifierBaseUrl + "/verifier/api/v1/request-verify",
                "POST", req.toJson());
    }
}
