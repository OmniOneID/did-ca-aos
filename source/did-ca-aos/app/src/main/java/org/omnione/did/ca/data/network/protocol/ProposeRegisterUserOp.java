...
public final class ProposeRegisterUserOp {

    private ProposeRegisterUserOp() {}

    public static String call(NetworkManager net, Context ctx, String tasBaseUrl)
            throws CommunicationException {
        P132RequestVo req = new P132RequestVo(CaUtil.createMessageId(ctx));
        return net.send(tasBaseUrl + "/tas/api/v1/propose-register-user", "POST", req.toJson());
    }
}
